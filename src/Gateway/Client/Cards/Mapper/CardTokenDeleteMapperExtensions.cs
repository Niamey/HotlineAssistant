...
{
	public static class CardTokenDeleteMapperExtensions
	{
		public static StatusCommandViewModel ToStatusCommandViewModel (this StatusCommandApiViewModel response)
		{
