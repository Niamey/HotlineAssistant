...
{
	public class CardBalanceApiModel : ResponseBaseModel
	{
		/// <summary>
		/// ИД договора в Солар
		/// </summary>
		...
		/// <summary>
		/// Начисл проценты на просроч. заемные ср-ва Проценты по ссудной задолженности Требования по комиссии за конвертацию Просроченные требования по комиссии за конвертацию 
		/// Требования по сервисным комиссиям Просроченные требования по сервисным комиссиям Требования по транзакционным комиссиям Просроченные требования по транз. комиссиям 
		/// Просроченная фин. деб задолженность Финансовая деб задолженность
		/// </summary>
